...
class ItemRequestControllerTest {
    ...
    void create() throws Exception {
        ...
        mvc.perform(post("/requests")
                ...
                .andExpect(jsonPath("$.requester", is(itemRequestDtoCreated.getRequester()), Long.class))
    ...
    void getOwnRequest() throws Exception {
        ...
        mvc.perform(get("/requests")
                ...
                .andExpect(jsonPath("$[0].requester", is(itemRequestDtoCreated.getRequester()), Long.class))
